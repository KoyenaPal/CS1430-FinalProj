...
conv = layers.Conv2D(8, 3, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(imgs_inputs)
conv = layers.LayerNormalization(axis=[1,2])(conv)
# (126, 126, 8)

conv = layers.Conv2D(16, 3, activation=act, strides=2, kernel_regularizer=l2, bias_initializer='glorot_uniform')(conv)
conv = layers.LayerNormalization(axis=[1,2])(conv)
conv = layers.AlphaDropout(0.05)(conv)
# (62, 62, 16)

conv = layers.Conv2D(32, 3, activation=act, strides=2, kernel_regularizer=l2, bias_initializer='glorot_uniform')(conv)
conv = layers.LayerNormalization(axis=[1,2])(conv)
conv = layers.AlphaDropout(0.05)(conv)
# (30, 30, 32)

conv = layers.Conv2D(64, 3, activation=act, strides=2, kernel_regularizer=l2, bias_initializer='glorot_uniform')(conv)
conv = layers.LayerNormalization(axis=[1,2])(conv)
conv = layers.AlphaDropout(0.05)(conv)
# (14, 14, 64)

conv = layers.Conv2D(16, 3, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(conv)
conv = layers.LayerNormalization(axis=[1,2])(conv)
# (12, 12, 16)
...
flat = layers.Dense(1024, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(flat)
...
combo = layers.Dense(1024, activation=act, bias_initializer='glorot_uniform')(combo)
combo = layers.LayerNormalization(axis=[1])(combo)
combo = layers.Dense(1024, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(combo)
combo = layers.LayerNormalization(axis=[1])(combo)
combo = layers.Dense(1024, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(combo)
combo = layers.LayerNormalization(axis=[1])(combo)
...
deconv = layers.Conv2DTranspose(16, 3, strides=2, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(deconv)
deconv = layers.LayerNormalization(axis=[1, 2])(deconv)
deconv = layers.Conv2DTranspose(16, 3, strides=2, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(deconv)
deconv = layers.LayerNormalization(axis=[1, 2])(deconv)
deconv = layers.Conv2DTranspose(16, 3, strides=2, activation=act, kernel_regularizer=l2, bias_initializer='glorot_uniform')(deconv)
deconv = layers.LayerNormalization(axis=[1, 2])(deconv)
deconv = layers.Conv2DTranspose(16, 3, strides=2, kernel_regularizer=l2, bias_initializer='glorot_uniform')(deconv)
deconv = layers.LayerNormalization(axis=[1, 2])(deconv)
